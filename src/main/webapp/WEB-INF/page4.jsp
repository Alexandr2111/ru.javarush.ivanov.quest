...
<head>
    ...
    <title>${requestScope.page4.title}</title>
...
<h2 class="tab" align="justify"> <pre> ${requestScope.page4.text} </pre> </h2> <br>

<a class="text-center" href="page1-servlet" style="color: #d00000">Не повезло! Что ж, попробуй снова.</a> <br>
...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="disabled"><a href="#">Расположение: <%= session.getAttribute("4title") %> </a></li>
